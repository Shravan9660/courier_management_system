...
input[type=text], input[type=password],select:focus {
  width: 100%;
  padding: 15px;
  margin: 5px 0 22px 0;
...
<form action="" method="GET">
  <div class="container">
    <h3 class="text">Please enter the branch name correctly.</h3>
    
    <hr>

    <label for="bname"><b>Branch Name</b></label>
    <input type="text" placeholder="Enter Registered Branchname" name="branch_name" value="<?php if(isset($_GET['branch_name'])) {echo $_GET['branch_name'];}?>" required>
  ...
  <div class="container">
      ...
      if(isset($_GET['branch_name']))
      {
          ...
          $query="SELECT * from branch where branch_name='$bname'";
          ...
          if(mysqli_num_rows($query_run)>0)
          {
              ...
              <div>
                <!--echo $row['custid'];-->
                <label for="id"><b>Branch id</b></label>
                <input type="text" placeholder="Branch Id" name="branch_id" value="<?=$row['branch_id']; ?>" disabled></div><?php
              }
 ...
 Employee Registration</h2></label><br>

    <label for="bid" ><b>Branch Id</b></label>
    <input type="text" Placeholder="Re-Enter the above Branch Id correctly"  name="bid" required >

    <label for="emph" ><b>Employee Phone</b></label>
    <input type="text"  name="emph" required >

    <label for="empname"><b>Employee Name</b></label>
    <input type="text"  name="empname" required >

    <label for="empaddr"><b>Employee Address</b></label><br>
    <input type="text"  name="empaddr" required >

    <label for="empemail"><b>Employee Email</b></label><br>
    <input type="text" placeholder="Enter the valid Email " name="empemail" required >
    
    <label for="rate"><b>Employee Rating</b></label><br>
    <input type="text" placeholder="Ex:6.5 or 9.5 Based on performance,initially Null" name="emprating" required >
    <label for="rate" style="color:black;font-weight:bold;">Note:Initially Null</label><br>
...
//for productid
    ...
    $sql="INSERT INTO employee(emp_id,branch_id,emp_ph,emp_name,emp_addr,emp_email,emp_rating)
     VALUES ('$myRandomString','$bid','$emph','$empname','$empaddr','$empemail','$emprating')";
    $result = mysqli_query($conn,$sql);
    if ($result) {
    echo "<script>alert('Wow! Employee Registration Completed.')</script>";
