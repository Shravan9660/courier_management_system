...
<body>
  ...
  <label class="a" for="cid"  ><h2>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
 Tracking Details</h2></label><br>
 <hr>
...
?>
  <tr>
    ...
    <td><?php echo $data['current_loc']; ?></td>
    <td><?php echo $data['status1']; ?></td>
    <td><?php echo $data['cur_date']; ?></td>
    <td><?php echo $data['del_date']; ?></td>
    <td><a href="deletebranch.php?tracking_id=<?php echo $data['tracking_id']; ?>">Delete</a></td>
    <td><a href="updatetracking.php?tracking_id=<?php echo $data['tracking_id']; ?>">Edit</a></td>
  </tr>	
<?php
}
?>
