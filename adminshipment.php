...
<form action="" method="GET">
  <div class="container">
    <h3 class="text">Please enter the Shipment Details.</h3>
    
    <hr>

    <label for="custname"><b>Customer Name</b></label>
    <input type="text" placeholder="Enter Registered Customer Name Correctly" name="custname" value="<?php ob_start(); if(isset($_GET['custname'])) {echo $_GET['custname'];}?>" required>
  ...
  <div class="container">
      ...
      {
          $cname=$_GET['custname'];
          $query="SELECT * from customer where custname ='$cname'";
 ...
 Add Shipment Details</h2></label><br>

    <label for="cid" ><b>Customer Id</b></label>
    <input type="text" Placeholder="Re-Enter the above Customer Id correctly"  name="cid" required >
  ...
  <option value="byair">By Air</option>
    ...
    <label for="shipd"><b>Shipment Date</b></label>
    ...
    <?php
      ...
      if(isset($_GET['custname']))
      {
          ...
          if(mysqli_num_rows($query_run)>0)
          {
              ...
              <div>
                <!--echo $row['custid'];-->
                <label for="id"><b>Customer Phone</b></label>
                <input type="text" placeholder="Customer Phone" name="custph" value="<?=$row['custph']; ?>" disabled></div><?php
              }
    ...
    <label for="custph"><b>Customer Phone</b></label><br>
    <input type="text" Placeholder="Please re-enter the above phone no correctly" name="custph" required >
...
{		
    ...
    $cid = $_POST['cid'];
    $shipesc = $_POST['shipdesc'];
    $shipd = date('Y-m-d',strtotime( $_POST['shipd']));
    $custph = $_POST['custph'];
...
//for productid
    ...
    $sql="INSERT INTO shipment(ship_id,cust_id,ship_desc,ship_date,cust_ph)
     VALUES ('$myRandomString','$cid','$shipesc','$shipd','$custph')";
