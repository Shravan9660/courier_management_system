...
if(isset($_POST['update'])) // when click on Update button
{
    ...
    $stat = $_POST['status1'];
    $curd =date('Y-m-d',strtotime( $_POST['cdate']));
    $del = date('Y-m-d',strtotime($_POST['shipd']));
	$sqli="update tracking set current_loc='$cloc', status1='$stat',cur_date='$curd',del_date='$del' where tracking_id='$id'";
...
<label for="cdate"><b>Current Date</b></label>
    <input type="date"  name="cdate" value="<?php echo $data['cur_date']; ?>" required >

    <label for="shipd"><b>Delivery Date</b></label>
    <input type="date"  name="shipd" value="<?php echo $data['del_date']; ?>" required >
    <hr>
