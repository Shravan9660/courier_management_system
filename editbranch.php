...
$sql="select branch_addr,branch_name,branch_ph from branch where branch_id='$id'";
...
if(isset($_POST['update'])) // when click on Update button
{
    ...
    $bname = $_POST['bname'];
    $bph = $_POST['branchph'];
	$sqli="update branch set branch_addr='$baddr', branch_name='$bname',branch_ph=$bph where branch_id='$id'";
...
<form method="POST">
  ...
  <label for="baddr" ><b>Branch Address</b></label>
    <input type="text" value="<?php echo $data['branch_addr'] ?>"   name="baddr" required >

    <label for="bname"><b>Branch Name</b></label>
    <input type="text" value="<?php echo $data['branch_name'] ?>"   name="bname" required >

    <label for="brph"><b>Branch Phone Number</b></label>
    <input type="text" value="<?php echo $data['branch_ph'] ?>"  placeholder="Enter the valid Phone number" name="branchph" required >
