...
<form action="" method="GET">
  <div class="container">
    <h3 class="text">Please enter the Tracking ID.</h3>
    
    <hr>

    <label for="tracking_id"><b>Tracking Id</b></label>
    <input type="text" placeholder="Enter Tracking Id" name="tracking_id" value="<?php ob_start(); if(isset($_GET['tracking_id'])) {echo $_GET['tracking_id'];}?>" required>
  ...
  <div class="container">
    ...
    <th>Delivery Date</th>
      ...
      {
          $cid=$_GET['tracking_id'];
          
        
        
         // Using database connection file here
        $sql="SELECT * from tracking where tracking_id='$cid' ";
