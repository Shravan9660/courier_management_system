...
<body>
  ...
  <label for="cid" style="text-align:center;" ><h2>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
 Register The Branch</h2></label><br>

    

    <label for="baddr" ><b>Branch Address</b></label>
    <input type="text"  name="baddr" required >

    <label for="bname"><b>Branch Name</b></label>
    <input type="text"  name="bname" required >

    <label for="brph"><b>Branch Phone Number</b></label>
    <input type="text" placeholder="Enter the valid Phone number" name="branchph" required >
    ...
    <h2 class="a" >Branch Details</h2><br>
...
//for productid
    ...
    $sql="INSERT INTO branch(branch_id,branch_addr,branch_name,branch_ph)
     VALUES ('$myRandomString','$baddr','$bname','$bph')";
    $result = mysqli_query($conn,$sql);
    if ($result) {
    echo "<script>alert('Wow! Branch Registration Completed.')</script>";
...
?>
  <tr>
    ...
    <td><?php echo $data['branch_addr']; ?></td>
    <td><?php echo $data['branch_name']; ?></td>
    <td><?php echo $data['branch_ph']; ?></td>
    <td><a href="deletebranch.php?branch_id=<?php echo $data['branch_id']; ?>">Delete</a></td>
    <td><a href="editbranch.php?branch_id=<?php echo $data['branch_id']; ?>">Edit</a></td>
  </tr>	
<?php
}
?>
